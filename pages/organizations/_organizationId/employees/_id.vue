    ...
    <v-layout align-center justify-center>
      <v-flex xs12 sm8 md6>
        <v-card class="elevation-12">
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn :dark="darkStatus" @click="store" :color="baseColor">Update Employee</v-btn>
          </v-card-actions>
        </v-card>
      </v-flex>
    </v-layout>
...
export default {
  ...
  created() {
    ...
    this.form.supervisor_id = parseInt(this.form.supervisors.length ? this.form.supervisors[0].id : '')
  },
  methods: {
    async store() {
